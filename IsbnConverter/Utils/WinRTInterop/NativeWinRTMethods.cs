...
namespace IsbnConverter.Utils.WinRTInterop;
...
internal static class NativeWinRTMethods
    {
        ...
        internal static extern unsafe IntPtr WindowsCreateString([MarshalAs(UnmanagedType.LPWStr)] string sourceString, int length);
        ...
        [DllImport("Windows.UI.Composition", EntryPoint = "DllGetActivationFactory", CallingConvention = CallingConvention.StdCall, PreserveSig = false)]
        private extern static IntPtr GetWindowsUICompositionActivationFactory(IntPtr activatableClassId);
